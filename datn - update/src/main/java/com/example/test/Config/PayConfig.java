...
//        Tên đăng nhập: nongoanh2000@gmail.com
//         Mk: Chaobuoisang161
...
public class PayConfig {
    ...
    public static String vnp_TmnCode = "5017UFXN";
    public static String vnp_HashSecret = "JQYGUJFZVPQSGOXSMLDLFPJVKHBOPDXW";
